...
const classUpgrades = {
  stage1: {
    Warrior: [ { id: 'item1', name: 'Skysplitter Sword', image: '/skysplittersword.png', cost: 40, minBonus: 3, maxBonus: 6, type: 'perClick' }, { id: 'item2', name: 'Golden Helm', image: '/goldenhelm.png', cost: 220, value: 3, type: 'perSecond', clickBonus: 2 }, { id: 'item3', name: 'Ring of Exalted Dexterity', image: '/ringofexalteddexterity.png', cost: 700, value: 8, type: 'perSecond', clickBonus: 4 }, ],
    Wizard: [ { id: 'item1', name: 'Staff of Astral Knowledge', image: '/staffofastralknowledge.png', cost: 45, minBonus: 1, maxBonus: 9, type: 'perClick' }, { id: 'item2', name: 'Magic Nova Spell', image: '/magicnovaspell.png', cost: 250, value: 4, type: 'perSecond', clickBonus: 1 }, { id: 'item3', name: 'Ring of Exalted Mana', image: '/ringofexaltedattack.png', cost: 750, value: 9, type: 'perSecond', clickBonus: 3 }, ],
    Sorcerer: [ { id: 'item1', name: 'Wand of Ancient Warning', image: '/woaw.png', cost: 50, minBonus: 4, maxBonus: 4, type: 'perClick' }, { id: 'item2', name: 'Scepter of Skybolts', image: '/sos.png', cost: 200, value: 5, type: 'perSecond', clickBonus: 1 }, { id: 'item3', name: 'Ring of Exalted Attack', image: '/ringofexaltedattack.png', cost: 800, value: 12, type: 'perSecond', clickBonus: 2 }, ],
  },
  stage2: {
    Warrior: [ { id: 'item4', name: 'Sword of Acclaim', image: '/soa.png', cost: 8000, minBonus: 40, maxBonus: 70, type: 'perClick' }, { id: 'item5', name: 'Helm of the Great General', image: '/hotgg.png', cost: 45000, value: 250, type: 'perSecond', clickBonus: 25 }, { id: 'item6', name: 'Ring of Unbound Attack', image: '/ringofunboundattack.png', cost: 120000, value: 600, type: 'perSecond', clickBonus: 60 }, ],
    Wizard: [ { id: 'item4', name: 'Staff of the Cosmic Whole', image: '/sotcw.png', cost: 9000, minBonus: 20, maxBonus: 120, type: 'perClick' }, { id: 'item5', name: 'Elemental Detonation Spell', image: '/eds.png', cost: 50000, value: 300, type: 'perSecond', clickBonus: 20 }, { id: 'item6', name: 'Ring of Unbound Dexterity', image: '/ringofunbounddexterity.png', cost: 135000, value: 650, type: 'perSecond', clickBonus: 55 }, ],
    Sorcerer: [ { id: 'item4', name: 'Wand of Recompense', image: '/wor.png', cost: 10000, minBonus: 55, maxBonus: 55, type: 'perClick' }, { id: 'item5', name: 'Scepter of Storms', image: '/sos.png', cost: 40000, value: 350, type: 'perSecond', clickBonus: 22 }, { id: 'item6', name: 'Ring of Unbound Attack', image: '/ringofunbounddexterity.png', cost: 150000, value: 800, type: 'perSecond', clickBonus: 40 }, ],
  },
  stage3: {
    Warrior: [ { id: 'item7', name: 'Pirate Kings Cutlass', image: '/pkc.png', cost: 350000, minBonus: 300, maxBonus: 600, type: 'perClick' }, { id: 'item8', name: 'Hivemaster Helm', image: '/hivehelm.png', cost: 800000, value: 2500, type: 'perSecond', clickBonus: 200 }, { id: 'item9', name: 'Battalion Banner', image: '/bb.png', cost: 2000000, value: 7000, type: 'perSecond', clickBonus: 500 }, ],
    Wizard: [ { id: 'item7', name: 'Superior', image: '/superior.png', cost: 400000, minBonus: 150, maxBonus: 850, type: 'perClick' }, { id: 'item8', name: 'Genesis Spell', image: '/gs.png', cost: 900000, value: 3000, type: 'perSecond', clickBonus: 150 }, { id: 'item9', name: 'Chancellors Cranium', image: '/cc.png', cost: 2200000, value: 7500, type: 'perSecond', clickBonus: 450 }, ],
    Sorcerer: [ { id: 'item7', name: 'Lumiaire', image: '/lumi.png', cost: 450000, minBonus: 400, maxBonus: 400, type: 'perClick' }, { id: 'item8', name: 'Scepter of Devastation', image: '/sod.png', cost: 750000, value: 3500, type: 'perSecond', clickBonus: 180 }, { id: 'item9', name: 'Divine Coronation', image: '/dc.png', cost: 2500000, value: 10000, type: 'perSecond', clickBonus: 400 }, ],
  },
};

const bosses = [ { id: 'oryx1', name: 'Oryx the Mad God', images: ['/oryx.png'], clickThreshold: 45000, clickSound: '/oryxhit.mp3', breakSound: '/oryxdeath.mp3', portalImage: '/winecellar.png', healThresholds: [{ percent: 50, amount: 10000 }] }, { id: 'oryx2', name: 'Oryx the Mad God 2', images: ['/oryx2.png'], clickThreshold: 100000, clickSound: '/oryxhit.mp3', breakSound: '/oryxdeath.mp3', portalImage: '/oryxchamber.png', healThresholds: [{ percent: 75, amount: 20000 }, { percent: 40, amount: 25000 }] }, { id: 'oryx3', name: 'Oryx the Mad God 3', images: ['/oryx3.png'], clickThreshold: 562500, clickSound: '/oryxhit.mp3', breakSound: '/oryxdeath.mp3', portalImage: null, healThresholds: [{ percent: 80, amount: 100000 }, { percent: 60, amount: 125000 }, { percent: 30, amount: 150000 }] }, { id: 'oryxexalted', name: 'Oryx the Mad God Exalted', images: ['/oryxexalted.png'], clickThreshold: 1250000, clickSound: '/oryxhit.mp3', breakSound: '/oryxdeath.mp3', portalImage: null, healThresholds: [] }, ];
...
const defaultState = { score: 0, pointsPerSecond: 0, currentBossIndex: 0, clicksOnCurrentBoss: 0, upgradesOwned: {}, playerClass: null, triggeredHeals: {}, exaltedShards: 0, prestigeUpgradesOwned: {}, totalClicks: 0, totalFameEarned: 0, bossesDefeated: {}, unlockedAchievements: {}, hasPrestiged: false, lastSavedTimestamp: null, };
...
function PixelClickerGame() {
    ...
    useEffect(() => {
        ...
        for (const ach of achievements) {
            if (!gameState.unlockedAchievements[ach.id] && ach.isUnlocked(gameState)) { newUnlocks.push(ach); }
        }
        if (newUnlocks.length > 0) {
            setGameState(prev => ({ ...prev, unlockedAchievements: { ...prev.unlockedAchievements, ...newUnlocks.reduce((obj, ach) => { obj[ach.id] = true; return obj; }, {}) } }));
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            setGameState(prev => ({ ...prev, score: prev.score + prev.pointsPerSecond, totalFameEarned: prev.totalFameEarned + prev.pointsPerSecond, }));
        }, 1000);
    ...
    useEffect(() => {
        ...
        if (gameState.clicksOnCurrentBoss >= currentBoss.clickThreshold) {
            setGameState(prev => ({ ...prev, bossesDefeated: { ...prev.bossesDefeated, [currentBoss.id]: (prev.bossesDefeated[currentBoss.id] || 0) + 1 } }));
            if (currentBoss.id === 'oryx3') { setGamePhase(GAME_PHASES.EXALTED_TRANSITION); return; }
            new Audio(currentBoss.breakSound).play();
            if (gameState.currentBossIndex === bosses.length - 1) { setGameWon(true); setGamePhase(GAME_PHASES.FINISHED); } else { setGamePhase(GAME_PHASES.TRANSITIONING); }
        }
    ...
    useEffect(() => {
        if (gamePhase === GAME_PHASES.EXALTED_TRANSITION) {
            const transitionTimer = setTimeout(() => {
                setGameState(prev => ({ ...prev, currentBossIndex: prev.currentBossIndex + 1, clicksOnCurrentBoss: 0, }));
                setIsInvulnerable(true);
                const invulnerabilityTimer = setTimeout(() => { setIsInvulnerable(false); setGamePhase(GAME_PHASES.CLICKING); }, 2000);
    ...
    useEffect(() => {
        if (!currentBoss || !currentBoss.healThresholds || gamePhase !== GAME_PHASES.CLICKING || isHealing) { return; }
        ...
        for (const heal of currentBoss.healThresholds) {
            if (currentHealthPercent <= heal.percent && !triggeredHealsForBoss.includes(heal.percent)) {
                setGameState(prev => ({ ...prev, triggeredHeals: { ...prev.triggeredHeals, [currentBoss.id]: [...triggeredHealsForBoss, heal.percent] } }));
                setIsHealing(true); let amountHealed = 0; const healPerIncrement = 2500;
                const healInterval = setInterval(() => {
                    const healThisTick = Math.min(healPerIncrement, heal.amount - amountHealed); amountHealed += healThisTick;
                    ...
                    if (gemButtonRef.current) {
                        ...
                        setFloatingHeals(current => [...current, { id: uuidv4(), value: healThisTick, x: rect.left + rect.width / 2 + (Math.random() * 80 - 40), y: rect.top + (Math.random() * 20 - 10), }]);
                    }
                    if (amountHealed >= heal.amount) { clearInterval(healInterval); setIsHealing(false); }
                }, 200);
                break;
            }
        }
    ...
    const calculateDamageRange = () => {
        ...
        currentUpgrades.forEach(upgrade => {
            ...
            if (owned > 0) {
                 ...
                 if (upgrade.type === 'perClick') { minDamage += (upgrade.minBonus || 0) * bonus; maxDamage += (upgrade.maxBonus || 0) * bonus; } else if (upgrade.type === 'perSecond' && upgrade.clickBonus) { minDamage += upgrade.clickBonus * bonus; maxDamage += upgrade.clickBonus * bonus; }
            }
        });
    ...
    const handleGemClick = (event) => {
        ...
        setFloatingNumbers(current => [...current, { id: uuidv4(), value: damageDealt, x: rect.left + rect.width / 2 + (Math.random() * 80 - 40), y: rect.top + (Math.random() * 20 - 10), }]);
        setIsShaking(true);
        setTimeout(() => setIsShaking(false), 150);
        setGameState(prev => ({ ...prev, score: prev.score + damageDealt, clicksOnCurrentBoss: prev.clicksOnCurrentBoss + damageDealt, totalClicks: prev.totalClicks + 1, totalFameEarned: prev.totalFameEarned + damageDealt, }));
    };

    const handleEnterPortal = () => { setGameState(prev => ({ ...prev, currentBossIndex: prev.currentBossIndex + 1, clicksOnCurrentBoss: 0, })); setGamePhase(GAME_PHASES.CLICKING); };
    ...
    const handleBuyUpgrade = (upgrade) => {
        ...
        if (gameState.score >= currentCost) {
            setGameState(prev => {
                ...
                if (upgrade.type === 'perSecond') { newPps += upgrade.value; }
                return { ...prev, score: prev.score - currentCost, pointsPerSecond: newPps, upgradesOwned: newOwned, };
            });
        } else { alert("Oopsie! Not enough points, cutie!"); }
    };
    ...
    const handleBuyPrestigeUpgrade = (upgrade) => {
        ...
        if (gameState.exaltedShards >= cost) {
            setGameState(prev => ({ ...prev, exaltedShards: prev.exaltedShards - cost, prestigeUpgradesOwned: { ...prev.prestigeUpgradesOwned, [upgrade.id]: (prev.prestigeUpgradesOwned[upgrade.id] || 0) + 1 } }));
        } else { alert("Not enough Exalted Shards!"); }
    };
    ...
    const handleResetSave = () => {
        ...
        if (isConfirmed) { localStorage.removeItem(SAVE_GAME_KEY); setGameState(defaultState); setGameWon(false); setGamePhase(GAME_PHASES.CLASS_SELECTION); }
    };
    
    if (gamePhase === GAME_PHASES.CLASS_SELECTION) { return ( <div className="card"> <div className="clicker-container"> <h3>Choose Your Class, Cutie!</h3> <div className="class-selection-container" style={{ display: 'flex', gap: '1rem', justifyContent: 'center', marginTop: '1rem' }}> {classes.map(pClass => ( <button key={pClass.id} className="btn-class-select" onClick={() => handleClassSelect(pClass.id)}> <img src={pClass.image} alt={pClass.name} /> <span>{pClass.name} {pClass.emoji}</span> </button> ))} </div> </div> </div> ); }
    ...
    return (
        <>
            ...
            <div className="achievement-alerts-container">
                {achievementAlerts.map((ach) => ( <div key={ach.id} className="achievement-alert" onAnimationEnd={() => setAchievementAlerts(current => current.filter(a => a.id !== ach.id))}> <strong>Achievement Unlocked!</strong> <p>{ach.name}</p> </div> ))}
            </div>
            <div className="card">
                ...
                <div className="clicker-container">
                    ...
                    <div className={`gem-button ${isHealing || isInvulnerable || gamePhase === GAME_PHASES.EXALTED_TRANSITION ? 'disabled' : ''}`} ref={gemButtonRef} onClick={handleGemClick}>
                        <img src={getCurrentImage()} alt={currentBoss.name} className={` ${gamePhase === GAME_PHASES.TRANSITIONING ? 'fading-out' : ''} ${gamePhase === GAME_PHASES.EXALTED_TRANSITION ? 'fading-out' : ''} ${isShaking ? 'shake' : ''} `} />
                    </div>
